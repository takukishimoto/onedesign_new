...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
      <Seo
        title="個人事業主・中小企業向けホームページ制作 ・WEB集客 | 八ヶ岳 諏訪市,茅野市,岡谷市,原村,富士見町,北杜市,韮崎市、伊那地域| ONE DESIGN"
        description="八ヶ岳,諏訪市,茅野市,岡谷市,原村,富士見町,北杜市、伊那地域のホームページ作成、WEB集客、グラフィックデザインはONE DESIGN（ワンデザイン）にお任せください"
      />
