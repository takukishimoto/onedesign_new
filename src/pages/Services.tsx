...
<PageHero
  ...
  bottom="ホームページ制作・グラフィックデザイン・WEBマーケティング・写真撮影・ブランディング"
/>
      ...
      <section className="pb-32 bg-background">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="space-y-8 text-muted-foreground leading-relaxed text-sm md:text-base">
            <p>
  八ヶ岳エリア（諏訪市・茅野市・原村・富士見町・北杜市・韮崎市）を拠点に活動するONE DESIGNは、
  個人事業主・中小企業向けに、ホームページ制作／WEB集客設計（SEO）／ロゴ・ブランディング／写真撮影まで
  一貫して対応するデザイン事務所です。
</p>

<p>
  10年以上の制作経験を活かし、見た目を整えるだけでなく「問い合わせにつながる導線」と「伝わる言葉」を設計します。
  施策の積み重ねで、お問い合わせの数を5倍、オンラインショップの売上を2年で約9倍に伸ばした実績もあります。
</p>

            <p>
              八ヶ岳地域の中小企業や個人事業の方が抱える
              「何から始めればいいかわからない」
              「今のホームページが機能していない」
              そんなホームページ制作やWEBマーケティングの悩みに寄り添い、本質的な課題解決を行います。
            </p>
          </div>
        </div>
      </section>
