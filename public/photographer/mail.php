...
<input type="submit" value="　送信する　"  id="btn01">
<input type="button" value="前画面に戻る" onClick="history.back()"  id="btn02"></p>
</form>
<?php } ?>
</div><!-- /formWrap -->
<!-- ▲ *********** 送信内容確認部　※編集は自己責任で ************ ▲-->
